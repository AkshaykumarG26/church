  ...
  return (
    ...
    <CCol className="m-auto" xs={6}>
      <CForm>
        ...
        <div className="mb-3">
          <CFormLabel htmlFor="exampleFormControlInput1">City ID</CFormLabel>
          <CFormInput
            type="Number"
            id="exampleFormControlInput1"
            placeholder="City"
        ...
        <div className="mb-3">
          <CFormLabel htmlFor="exampleFormControlInput1">Zipcode</CFormLabel>
          <CFormInput
            type="Number"
            id="exampleFormControlInput1"
            placeholder="Zipcode"
        ...
        <div className="mb-3">
          <CFormLabel htmlFor="exampleFormControlInput1">Tel Number</CFormLabel>
          <CFormInput
            type="Number"
            id="exampleFormControlInput1"
        ...
        <div className="mb-3">
          <CFormLabel htmlFor="exampleFormControlInput1">Race ID</CFormLabel>
          <CFormInput
            type="Number"
            id="exampleFormControlInput1"
            placeholder="Race ID"
        ...
        <div className="mb-3">
          <CFormInput type="Submit" id="exampleFormControlInput1" pla />
        </div>
      </CForm>
    </CCol>
  );
